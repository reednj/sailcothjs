define(['exports', './types.js'], function (exports, _types) {
	...
	class Viewport {
		...
		get rect() {
			return this._rect = this._rect || new _types.Rect(0, 0, this._width, this._height);
		}
	...
	class WorldViewport extends Viewport {
		...
		get rect() {
			return this._rect = this._rect || new _types.Rect(this.origin.x, this.origin.y, this._width, this._height);
		}
