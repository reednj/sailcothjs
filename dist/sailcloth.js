...
var WorldViewport = exports.WorldViewport = function (_Viewport) {
	...
	function WorldViewport(element) {
		...
		var _this4 = _possibleConstructorReturn(this, (WorldViewport.__proto__ || Object.getPrototypeOf(WorldViewport)).call(this, element, options));

		_this4.origin = _this4.options.origin || { x: 0, y: 0 };
		_this4.staticQueue = [];
		_this4.worldQueue = [];
		return _this4;
	}
